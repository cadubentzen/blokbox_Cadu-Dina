...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/blokbox1.0.0/ && $(COPY_FILE) --parents resources.qrc .tmp/blokbox1.0.0/ && $(COPY_FILE) --parents spectrograph.h fft.h controls.h fftcalc.h mediainfo.h abstractcontrol.h abstractspectrograph.h abstractmediainfo.h medialibrary.h playlistmodel.h lightcycle.h mainwindow.h .tmp/blokbox1.0.0/ && $(COPY_FILE) --parents main.cpp spectrograph.cpp fft.cpp controls.cpp fftcalc.cpp mediainfo.cpp medialibrary.cpp playlistmodel.cpp lightcycle.cpp mainwindow.cpp .tmp/blokbox1.0.0/ && $(COPY_FILE) --parents controls.ui mediainfo.ui medialibrary.ui mainwindow.ui .tmp/blokbox1.0.0/ && (cd `dirname .tmp/blokbox1.0.0` && $(TAR) blokbox1.0.0.tar blokbox1.0.0 && $(COMPRESS) blokbox1.0.0.tar) && $(MOVE) `dirname .tmp/blokbox1.0.0`/blokbox1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/blokbox1.0.0
