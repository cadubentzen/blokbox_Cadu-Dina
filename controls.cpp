...
Controls::Controls(QWidget *parent):
  ...
  // nice colors buttons
  ui->pushButtonNext->setStyleSheet(QString("QPushButton { background-color: red; border: none; }"));
  ui->pushButtonPlayPause->setStyleSheet(QString("QPushButton { background-color: red; border: none; }"));
  ui->pushButtonPrev->setStyleSheet(QString("QPushButton { background-color: red; border: none; }"));
...
void Controls::onColorChanged(QColor cor)
{
  ...
  ui->pushButtonPlayPause->setStyleSheet(QString("QPushButton { background-color: ") + cor.name() + QString("; border: none; }"));
  ui->pushButtonPrev->setStyleSheet(QString("QPushButton { background-color: ") + cor.name() + QString("; border: none; }"));
  ui->lcdNumberDuration->setStyleSheet(QString("QLCDNumber { color: ") + cor.name() + QString("; border: none; }"));
  ui->lcdNumberElapsed->setStyleSheet(QString("QLCDNumber { color: ") + cor.name() + QString("; border: none; }"));
  ui->line->setStyleSheet(QString("QFrame {color: ") + cor.name() + QString(";}"));
}
